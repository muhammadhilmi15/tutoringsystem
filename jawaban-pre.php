  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Hasil Pre - Test</h3>
            <ul class="panel-controls">
          ...
          <div class="panel-footer">
            ...
            <a href="index.php?p=update-tingkatan&&id_kemampuan=<?php echo $id_kemampuan;?>"><input type="button" class="btn btn-primary pull-right" value="Lanjut"></a>
          </div>
        </div>
      </div>
    </div>
